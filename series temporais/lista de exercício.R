...
# Questão 1
#Considerando os dados (M-Energia) do anos de janeiro de 1968 à dezembro de 1969
#sobre consumo de energia elétrica no estado do Espírito Santo:
...
#letra c - Calcule as médias móveis por trimestre e por quadrimestre. Em seguida, adicione
#essas informações ao gráco das observações obtido no item a).
...
#Analise cada um dos conjuntos de dados abaixo e ajuste um modelo para tendências,
...
# questão 3
#Analise cada um dos conjuntos de dados abaixo e ajuste um modelo de suavização
